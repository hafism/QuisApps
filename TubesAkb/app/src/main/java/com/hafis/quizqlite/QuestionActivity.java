...
import static com.hafis.quizqlite.CategoryAdapter.CATEGORY_COLOR;
import static com.hafis.quizqlite.CategoryAdapter.CATEGORY_ID;
...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (categoryBundle != null) {
            mQuestionList = mDbHelper.getAllQuestions(categoryBundle.getString(CategoryAdapter.CATEGORY_ID));
            mTotalQuestions = mQuestionList.size();
            mScore = 0;
            displayScore();
        }
        mAdapter = new QuestionAdapter(this, mQuestionList, categoryBundle.getString(CategoryAdapter.CATEGORY_ID));
